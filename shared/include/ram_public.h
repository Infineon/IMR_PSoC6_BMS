...
#include "../../proj_cm4/Libraries/BMS_Functionalities/diagnostic.h"
...
typedef enum {
	PUBLIC_COMMAND_IGNORE = 0,
	PUBLIC_COMMAND_REFRESH ,
	PUBLIC_COMMAND_SHUTDOWN,
	PUBLIC_COMMAND_DONE
} public_core_commands;
...
// Address definition of every element in public ram.
// The size of the last element must always be the start of
// the next one (size must stack up)
// To add a new element:
//    - Create a new line below last element,
//		copy last element address macro down and
//		change type in sizeof to new element type:

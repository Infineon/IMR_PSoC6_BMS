/*
 * safety_switch.c - Abstraction off all safety switch related functions that need to be accessed from main.
 * 					 This way the driver library does not need to be implemented hard into main file.
 * 					 Note that diagnostics are however used directly (not throu this wile).
 *
...
//****************************************************************************
// getSwitchState - Check if both channels are ON. Returns 0 if switch is OFF (non conducting)
...
// Returns 0 if switch is OFF (non conducting) and 1 if switch is ON (conducting). Anything else is considered error
// useCachedReg			- If set to 0 the last information about the switch state is used, if set to 1 the information is requested anew
//****************************************************************************
...
//****************************************************************************
// setSwitchState_precharge - Sets the precharge channel B ON if state is 1 or off if state is 0
//****************************************************************************
...
//****************************************************************************
// setSwitchState_mainpath - Sets the main channel A ON if state is 1 or off if state is 0
//****************************************************************************
...
//****************************************************************************
// setSwitchIsolating - Stop current thru the switches. Returns 1 if error and 0 if ok
//****************************************************************************

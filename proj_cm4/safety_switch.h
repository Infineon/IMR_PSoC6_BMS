/*
 * safety_switch.h - Abstraction off all safety switch related functions that need to be accessed from main.
...
#ifndef SAFETY_SWITCH_H_
#define SAFETY_SWITCH_H_

/*******************************************************************************
* DEFINITIONS
*******************************************************************************/
#define USE_REG_CACHED_SS USE_REG_CACHED
#define USE_REG_RENEW_SS  USE_REG_RENEW

#define SET_SAFE_STATE_ON   0
#define SET_SAFE_STATE_OFF  1

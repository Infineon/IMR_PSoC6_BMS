...
typedef struct IMR_CAN_MESSAGE_STRUCT {
	...
	uint8_t  CAN_DATA[8];	// Stores the CAN data associated with
...
typedef enum IMR_CAN_MESSAGE_IDS {
    ...
    PD_FRONT_CH1TO3_OUTPUT_CURRENT = 0x280,
    PD_BACK_CH1TO3_OUTPUT_CURRENT = 0x281,
    PD_FRONT_CH4TO6_OUTPUT_CURRENT = 0x290,
    PD_BACK_CH4TO6_OUTPUT_CURRENT = 0x291,

...
typedef enum {
	Fail_SYS_OL_ERR = 8192U,
	Fail_SYS_INT_IC_ERR = 16384U,
	Fail_SYS_REG_CRC_ERR = 32768U,
	Fail_SYS_EXT_T_ERR = 65536U,
	Fail_SYS_INT_OT = 131072U,
	Fail_SYS_CELL_UV = 262144U,
	Fail_SYS_CELL_OV = 524288U,
	Fail_SYS_BAL_ERR_UC = 1048576U,
	Fail_SYS_BAL_ERR_OC = 2097152U,
	Fail_SYS_PS_ERR_SLEEP = 4194304U,
	Fail_SYS_ADC_ERR = 8388608U
} FailureFlags_tle9012;
/*
typedef enum {
	Warn_1 = 1
} WarningFlags_tle9012;
typedef enum {
	Monitor_1 = 2
} MonitoringFlags_tle9012;*/

// All Request return one of the following results.
// All error codes greater or equal to REQUEST_ERROR can be considered failed
typedef enum {
	REQUEST_OK = 0U,
	REQUEST_ADDED = 1U,
	REQUEST_REGISTER_NOT_READY = 2U,
	REQUEST_REGISTER_DATA_INVALID_OR_OLD = 3U,
	REQUEST_REGISTER_ALREADY_QUEUED = 4U,
	REQUEST_ERROR = 5U,
	REQUEST_ADD_FAILED = 6U,
	REQUEST_TIMEOUT = 7U,
	REQUEST_DONE_BUT_REGISTER_NOT_READY = 8U
} requestResult;
...
requestResult tle9012_writeMultiReadConfig(uint8_t nodeID, uint16_t pcvm_sel,
		...
		uint16_t int_temp_sel, uint16_t scvm_sel, uint16_t stress_pcvm_sel,
		uint8 isBlocking);
...
// Diagnostic
requestResult tle9012_clearStatusFlags(uint8_t nodeID, uint8_t isBlocking,
		uint8_t isBroadcast);

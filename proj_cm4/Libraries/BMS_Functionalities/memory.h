...
#define MEM_ADDR_STORED_MEMORY_VALID	0x0000	// Address where the memory valid value
												// is stored
#define MEM_SIZE_STORED_MEMORY_VALID	1		// Size of the memory valid value
#define MEM_COMP_STORED_MEMORY_VALID	42		// Compare value for the memory valid value.
												// If the byte in MEM_ADDR_STORED_DATA_READY
												// is set to this valid the memory is
												// considered valid (not the first write
												// and simple check if memory working)
...
#define MEM_ADDR_NEXT_RT_DATA_ADDR	0x0003	// Address where the next written index
											// for runtime data storage is stored
#define MEM_SIZE_NEXT_RT_DATA_ADDR	2		// Size of the next written index for
...
#define MEM_ADDR_RT_DATA_START	0x000A	// Address where the stored settings and
										// status values start and the storing of
										// runtime data starts

...
#define PACKAGE_R_COMMAND_CRC_FRAME_IDX 	2	// Read commands have no data, therefore the CRC comes next
...
#define PACKAGE_W_REPLY_FRAME_IDX 			5	// Write relies have a special reply frame at index 5
...
//****************************************************************************
//uint16_t receive_index; // The index of the last byte in the receive ring buffer, new bytes will be added after this index
//uint16_t interpreter_index; // The index of the currently processed byte in the receive ring buffer

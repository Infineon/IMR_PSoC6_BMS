/*
 * IMR_CAN.h - Abstraction off all CAN receive and transmit actions. Valid incoming messages set flags that are handled and reset in main.
 *
...
#define CAN_MAX_DATA_LENGTH						8					/* Maximum size of the data to be analyzed */

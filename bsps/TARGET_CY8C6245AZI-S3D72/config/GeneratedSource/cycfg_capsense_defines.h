...
#define CY_CAPSENSE_NOISE_ENVELOPE_SIZE                                          (1u)
...
#define CY_CAPSENSE_SCAN_MODE                                                    (CY_CAPSENSE_SCAN_MODE_INT_DRIVEN)
#define CY_CAPSENSE_TOTAL_CH_NUMBER                                              (1u)
#define CY_CAPSENSE_SLOT_COUNT                                                   (1u)
#define CY_CAPSENSE_SENSOR_CONNECTION_MODE                                       (CY_CAPSENSE_CTRLMUX_SENSOR_CONNECTION_METHOD)
#define CY_CAPSENSE_SENSOR_CONNECTION_MODE_LEGACY                                (0u)
#define CY_CAPSENSE_SENSOR_FRAME_SIZE                                            (6u)
...
#define CY_CAPSENSE_CSD_CDAC_COMP_EN                                             (1u)
#define CY_CAPSENSE_CSD_CDAC_COMP_DIV_AUTO_EN                                    (1u)
#define CY_CAPSENSE_CSD_CDAC_REF_AUTO_EN                                         (1u)
#define CY_CAPSENSE_CSD_CDAC_ROW_COL_ALIGN_EN                                    (1u)
#define CY_CAPSENSE_CSX_CDAC_COMP_EN                                             (1u)
#define CY_CAPSENSE_CSX_CDAC_COMP_DIV_AUTO_EN                                    (1u)
#define CY_CAPSENSE_CSX_CDAC_REF_AUTO_EN                                         (1u)
#define CY_CAPSENSE_LFSR_EN                                                      (0u)
#define CY_CAPSENSE_LFSR_AUTO_EN                                                 (0u)
#define CY_CAPSENSE_CLOCK_SOURCE_AUTO_EN                                         (0u)
...
#define CY_CAPSENSE_SLIDER_EN                                                    (0u)
...
#define CY_CAPSENSE_CIC2_FILTER_EN                                               (0u)

...
#if !defined(CY8C6245AZI_S3D72)
#error "Unexpected MPN; expected DEVICE:=CY8C6245AZI-S3D72. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C6245AZI_S3D72) */
